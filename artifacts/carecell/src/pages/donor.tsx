          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 relative z-10">
            <div>
              <input
                ...
                className={`w-full px-5 py-4 rounded-2xl border bg-background/50 text-white placeholder:text-muted-foreground/60 focus:ring-2 focus:ring-primary/50 outline-none transition-all text-sm shadow-sm ${errors.name ? 'border-primary/60' : 'border-border'}`}
              />
            ...
            <div>
              <input
                ...
                type="tel"
                className={`w-full px-5 py-4 rounded-2xl border bg-background/50 text-white placeholder:text-muted-foreground/60 focus:ring-2 focus:ring-primary/50 outline-none transition-all text-sm shadow-sm ${errors.phone ? 'border-primary/60' : 'border-border'}`}
              />
            ...
            <motion.button
              ...
              className="w-full py-4 rounded-2xl font-bold text-background bg-white shadow-xl transition-all disabled:opacity-50 mt-2 flex items-center justify-center gap-2"
            >
      ...
      <div className="pl-5 space-y-4">
        ...
        <div className="flex gap-4 overflow-x-auto pb-6 pr-5 snap-x snap-mandatory hide-scrollbar">
          {isLoading ? (
            ...
            <div className="text-muted-foreground text-sm py-4">No donors registered yet.</div>
          ) : (
            donors?.map(donor => (
